...
class CdcSD : public MySD
{
	...
	private:
		...
		std::vector<double> m_xin;
		std::vector<double> m_yin;
		std::vector<double> m_zin;
		std::vector<double> m_xout;
		std::vector<double> m_yout;
		std::vector<double> m_zout;
		...
		std::string unitName_xin;
		std::string unitName_yin;
		std::string unitName_zin;
		std::string unitName_xout;
		std::string unitName_yout;
		std::string unitName_zout;

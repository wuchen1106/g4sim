...
//  class MyElementField - interface for the EM field of one element
...
class MyElementField {

    private:

        MyElementField& operator=(const MyElementField&);
    ...
    public:
        ...
        virtual ~MyElementField() {
            if (aNavigator) delete aNavigator;
            if (boundingBox) delete boundingBox;
        }

        // Get center of physical field volume
        G4ThreeVector getCenter(){return center;}

        // Set center of physical field volume
        ...
        // Get dimensions for the bounding box
    ...
    protected:
        ...
        //    MyElementField(const MyElementField&);

...
//  MyGlobalField - handles the global ElectroMagnetic field
//
...
class MyGlobalField : public G4ElectroMagneticField {
    //class MyGlobalField : public G4MagneticField {
    ...
    public:
        ...
        /// getObject() returns the single MyGlobalField object.
        ...
        void addElementField(MyElementField* f) { if (fields) fields->push_back(f); }

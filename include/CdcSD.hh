...
class CdcSD : public MySD
{
  ...
  private:
		...
		int FindClosestPoint(G4ThreeVector &, double &, G4ThreeVector, G4ThreeVector, G4ThreeVector, G4ThreeVector, int, int, int);
		int check_type(G4double a[6], G4double phi);
		double NewtonRootFinding(G4double a[6], G4double phi, G4int nTry, G4double torl);

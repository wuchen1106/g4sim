...
cd geant4-build/
#cmake -DCMAKE_INSTALL_PREFIX=../geant4-install -DGEANT4_INSTALL_DATA=ON -DGEANT4_USE_QT=ON -DGEANT4_USE_G3TOG4=ON -DGEANT4_USE_RAYTRACER_X11=ON ../geant${GEANT4_VERSION}/ 2>&1 |tee install_log.txt
cmake -DCMAKE_INSTALL_PREFIX=../geant4-install -DGEANT4_INSTALL_DATA=ON -DGEANT4_USE_G3TOG4=ON -DGEANT4_USE_RAYTRACER_X11=ON ../geant${GEANT4_VERSION}/ 2>&1 |tee install_log.txt
